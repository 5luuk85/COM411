...
#[2]".cla" means clear axes, each new frame will be drawn on a new axes so that when the  plot is bening animated or drawn, they do not overlap. In this case each dot will be drawn on the different points on the frame it is on and the previous frame/drawing is not shown while the animation is running.
